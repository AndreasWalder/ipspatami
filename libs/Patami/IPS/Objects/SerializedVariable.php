...
/**
 * Provides a IPS string variable object that stores data as a serialized string.
 * @package IPSPATAMI
 */
class SerializedVariable extends StringVariable
{
     ...
     * @throws VariableInvalidDataException if the data could not be unserialized.
     */
    public function Get()
    {
        // Get the text
        ...
        // Throw an exception if the data could not be deserialized
        if ($object === false) {
     ...
     * @param mixed $data New data to be stored as serialized string.
