...
/**
 * Provides an OO implementation of a boolean IPS variable object.
 * @package IPSPATAMI
 */
class BooleanVariable extends Variable
{
    ...
    {
        return self::VARIABLE_TYPE_BOOLEAN;
    }

    /**
     * Returns the value of the IPS variable object.
     * @return bool Value of the variable.
     * @see IPS::GetValueBoolean()
     */
    public function Get()
    {
        return IPS::GetValueBoolean($this->objectId);
    }
     ...
     * @see IPS::SetValueBoolean()
     */
    public function Set($value)
    {
        // Set the value via IPS
        $result = IPS::SetValueBoolean($this->objectId, $value);
