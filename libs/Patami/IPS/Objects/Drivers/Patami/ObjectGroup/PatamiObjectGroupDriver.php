...
/**
 * Abstract base class for Patami Object Group IPS drivers.
 * @package IPSPATAMI
 */
abstract class PatamiObjectGroupDriver extends Driver
{
    ...
    protected function ValidateObject()
    {
        ...
        if (! $this->object->IsModuleId('{ED1BD621-3BA5-48C1-A016-33E6AECA12F2}')) {
            throw new InvalidObjectException();
        }
    }
