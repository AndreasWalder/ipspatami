...
/**
 * IPS Driver for KNX devices that support getting or settings float values.
 * @package IPSPATAMI
 */
class KNXFloatValueDriver extends KNXDriver implements
    GetNumberInterface,
    SetNumberInterface
{
    ...
    {
        // Set the value
        $result = KNX::SendFloatValue($this->object->GetId(), $value);
