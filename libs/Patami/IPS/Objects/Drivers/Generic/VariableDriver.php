...
/**
 * Abstract base class for IPS variable object drivers.
 * @package IPSPATAMI
 */
abstract class VariableDriver extends Driver
{

    /**
     * @var Variable IPS variable object instance.
     */
    protected $object;
