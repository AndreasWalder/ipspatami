...
/**
 * IPS Driver for an IPS integer or float variable.
 * @package IPSPATAMI
 */
class VariableNumberDriver extends VariableDriver implements
    GetNumberInterface,
    SetNumberInterface
{
     ...
     * - be a float or integer variable.
    ...
    protected function ValidateObject()
    {
        ...
        if (! $this->object instanceof FloatVariable && ! $this->object instanceof IntegerVariable) {
