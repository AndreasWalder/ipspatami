...
/**
 * IPS Driver for HomeMatic switches.
 * @package IPSPATAMI
 */
class HomeMaticSwitchDriver extends HomeMaticDriver implements
    GetSwitchInterface,
    SetSwitchInterface,
    StateInterface
{
     ...
     *     - have the variable profile '~Switch'.
    ...
    protected function ValidateObject()
    {
        ...
        $value = $this->object->GetChildByIdent('STATE');
        ...
        if (! $value->HasProfileName(VariableProfiles::TYPE_SWITCH)) {
            throw new InvalidObjectException();
        }
    ...
    public function SetSwitch($value)
    {
        ...
        $result = @HM_WriteValueBoolean($this->object->GetId(), 'STATE', $value);
