...
class HelpIntent extends ModuleIntent
{
    ...
    protected function DoExecute(Request $request)
    {
        return AskResponse::CreatePlainText(
            ...
            'Mögliche Objekttypen sind Objekte, Bibliotheken, Module, Instanzen, Variablen, Skripte, Funktionen, ' .
            'Ereignisse, Medien, Links und Kategorien.'
