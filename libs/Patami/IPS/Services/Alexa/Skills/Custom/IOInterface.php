...
/**
 * Interface used to define the required methods to retrieve information required by a request from a WebHook or
 * WebOAuth I/O module.
 * @package IPSPATAMI
 */
interface IOInterface
{
    ...
    /**
     * Returns the allowed Alexa Custom Skill application ID.
